#!/bin/bash
# =============================================================
# MarketMind Backend — AWS EC2 Setup Script
...
echo "=================================================="
echo "  MarketMind Backend — AWS EC2 Setup"
echo "=================================================="
...
# ── 3. Open UFW Firewall Ports (internal OS firewall) ────────
...
server {
    ...
    location / {
        ...
        # Critical for SSE streaming (Ask Edith)
        proxy_buffering off;
...
echo "  Test: curl http://$(curl -s http://169.254.169.254/latest/meta-data/public-ipv4)/"
echo "=================================================="
